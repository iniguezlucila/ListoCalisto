...
(function( $ ) {
  ...
  SalientPortfolio.prototype.portfolioItemWidths = function() {
    ...
    if(isFullWidth) { 
      ...
      if( $elWidth % $colSize === 0 ) {
        ...
        this.$el.find('.elastic-portfolio-item:not(.wide):not(.wide_tall1)').css('width',Math.floor($elWidth/$colSize) +'px');
        this.$el.find('.elastic-portfolio-item.wide, .elastic-portfolio-item.wide_tall1').css('width',Math.floor($elWidth/$colSize*$mult) +'px');
      } else {
        ...
        for(var i = 1; i<$loopEndNum; i++) {
          if( ($elWidth - i) % $colSize === 0 ) {
            ...
            this.$el.find('.elastic-portfolio-item:not(.wide):not(.wide_tall1)').css('width',($elWidth-i)/$colSize +'px');
            this.$el.find('.elastic-portfolio-item.wide, .elastic-portfolio-item.wide_tall1').css('width',($elWidth-i)/$colSize*$mult +'px');
          }
        }
  ...
  SalientPortfolio.prototype.beforeReLayout = function() {
    ...
    if(!this.$el.is('[data-bypass-cropping="true"]')) {
      ...
      this.$el.find('.col.elastic-portfolio-item[class*="wide_tall1"]:visible').length > 0) {
        ...
        if(this.$el.find('.col.elastic-portfolio-item[class*="regular"]:visible').length === 0 && 
          ...
          this.$el.find('.col.elastic-portfolio-item.wide_tall1:visible').length > 0) {
          
          $itemClassForSizing = 'wide_tall';
          multipler = 1;

          $itemClassForSizing = 'wide_tall1';
          multipler = 1;
          
        } else if(this.$el.find('.col.elastic-portfolio-item[class*="regular"]:visible').length === 0 && 
          this.$el.find('.col.elastic-portfolio-item.tall:visible').length > 0)
          this.$el.find('.col.elastic-portfolio-item.tall1:visible').length > 0) {
          
          $itemClassForSizing = 'tall';
          multipler = 1;

          $itemClassForSizing = 'tall1';
          multipler = 1;
